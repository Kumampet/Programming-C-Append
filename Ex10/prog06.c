...
typedef struct{
  ...
  int flagCount;//すべて配置した旗の数
  int correctCount;//正しい配置をした旗の数
  int bombs;//設置する地雷の数
}Map;

void Initialize(Map*);//マップの初期化
int Judge(Map*);//ゲーム続行の是非を問う
void View(Map);//盤面を表示
void Open(Map*);//盤面の地雷がある場所を開く
